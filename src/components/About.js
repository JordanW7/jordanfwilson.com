  ...
  return (
    <div className="aboutfull">
  	<div className="about">
        ...
        <p><span className="about-contents-header">#ThinkDifferent</span><br />I completed a <span className="highlight">Bachelor of Music with Honours (1st) in Music Composition</span> after leaving High School, which gives me a unique background and skillset.  Thinking creatively, problem solving, being responsible and dependable, being able to work well with others and communicate effectively, critical reflection, performing under pressure, adaptability, analytical skills, attention to detail, self-management, planning and time management skills are all second nature to music graduates. <span className="highlight">Musicians are becoming increasingly known for being excellent developers.</span> Albert Einstein said, "the greatest scientists are artists as well."</p>
