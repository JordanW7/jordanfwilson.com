  	...
  	<div className="skills">
        ...
        <Col span={24} className="skills-card">
          <Row type="flex" justify="center" align="middle">
            ...
            <Col xs={24} sm={24} md={18} lg={18} xl={18} className="skills-details">
            <p className="skills-list">· Node.js · Express · PostgreSQL</p>
            </Col>
          </Row>
        </Col>
        ...
        <Col span={24} className="skills-card">
          <Row type="flex" justify="center" align="middle">
            ...
            <Col xs={24} sm={24} md={18} lg={18} xl={18} className="skills-details">
            <p className="skills-list">· bcrypt</p>
            </Col>
          </Row>
        </Col>
        ...
        <Col span={24} className="skills-card">
          <Row type="flex" justify="center" align="middle">
            ...
            <Col xs={24} sm={24} md={18} lg={18} xl={18} className="skills-details">
            <p className="skills-list">· Chrome DevTools · command-line · Git · npm · Heroku</p>
            </Col>
          </Row>
        </Col>
        ...
        <Col span={24} className="skills-card">
          <Row type="flex" justify="center" align="middle">
            ...
            <Col xs={24} sm={24} md={18} lg={18} xl={18} className="skills-details">
            <p className="skills-list">· Responsive web design · Mobile-first development · Cross-browser compatibility</p>
            </Col>
          </Row>
        </Col>
      </Row>
